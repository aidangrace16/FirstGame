...
public class MonsterNavChase : MonoBehaviour
{
    ...
    public bool isPrimaryChaser = false;
    [Range(-1f,1f)]
    ...
    [HideInInspector]
    public bool mainMonsterChasing = false;
    ...
    void Start()
    {
        ...
        // reset the flag every time the scene/play mode starts
        if (isPrimaryChaser) mainMonsterChasing = false;
    ...
    void Update()
    {
        ...
        if (isPrimaryChaser && canSee && !isAttacking)
        {
            mainMonsterChasing = true;
        }
